...
\begin{tikzpicture}
  ...
  \draw[draw=black] (JAVANA) -- (JAVANAT);
  ...
  \draw[draw=black] (Javassist) -- (JavassistT);
  ...
  \draw[draw=black] (Eclipse) -- (EclipseT);
