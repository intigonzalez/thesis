...
\extracomment{TODO}{
One paragraph to say that this is an illustrative case because of the current trend of developing new DSLs.
Somehow I have to connect all this using something said by Czarnecki.
}
...
DSLs can be roughly classified as internal or external.
...
Likewise, design patterns and reflection are used to implements some forms of internal DSLs, such as fluent APIs, and annotation-based languages.
...
Xtext~\cite{Eysholdt:2010:XIY:1869542.1869625} is a well-known framework for defining new DSLs.
...
\extracomment{TODO}{
A Figure to depict the problem of indirect vs direct accounting.
}
...
\extracomment{TODO}{
One paragraph to discuss that there are two ways of measuring memory consumption: either the allocator is always responsible or the component that keeps an object live is responsible
}
...
\extracomment{TODO}{
One paragraph to introduce the section
}
...
\begin{itemize}
\item Limited support for resource accounting in component-based systems.
They only target mainstream component models. In general they induce high performance overhead.

\item Sub-utilization of information about the architecture of systems.

\item Wrongly assume that resource consumption is homogeneous.

\item Limited capabilities for building tooling support.
