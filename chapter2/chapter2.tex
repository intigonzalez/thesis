...
For instance, the already discussed Xtext, the Eclipse Modeling Framework, the meta-programming capabilities of languages such as Scala and Clojure where internal DSLs can be defined and executed, the combination of annotations and annotation processor, and  the Meta-Programming System (MPS).
Likewise, F\# applications, which execute in CLR, can use meta-programming support to write DSLs; and the Boo language provides constructor that are easy to use for crafting DSLs. 
