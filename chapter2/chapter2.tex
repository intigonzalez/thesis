...
\begin{itemize}
%\item El apoyo para la cuestion de los lenguajes es limitado
...
To perform the scheduling, each proflet provides an estimates of both the expected application overhead and the time needed to set up the detailed monitoring; this information is used to dispatch the execution of a detailed recollection of data.
...
The recollection of data for a given dynamic analysis can be easily understood as a crosscutting concern.
...
Defining and using software abstractions is at the core of system developments.
The capacity of defining new abstraction is, at the same time, a blessing and a challenge.
The problem is that once a new abstraction is defined, the tools that support the development process should be modified to make them reflect the concepts 
