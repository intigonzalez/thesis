...
In this case, it is necessary to know how is done the translation process from the DSL to a general-purpose language in order to properly measure the CPU consumption.
