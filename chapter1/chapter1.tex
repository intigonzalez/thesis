...
\coolphrase {
 ...
 \emph{The Wolf} - That's thirty minutes away. I'll be there in ten. \hspace*{36 mm} 
 ...
 \emph{The Wolf} - [\dots] what I need you two fellas \textbf{(meaning Jules and Vincent)} to \hspace*{2 mm} \\
...
In the same way, some work has been done in devising \textit{fully portable} resource reservation upon existent MRTEs.
...
Each subsystem have, however, constraints regarding how they can be used.
...
Additionally, the weaknesses of different techniques (Some values in the table are marked with the symbols $ \downarrow $ and $\downarrow\downarrow$, denoting weak and very weak points respectively.) are detailed highlighted.
