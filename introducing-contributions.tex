...
\foreach [count=\c] \x/\cy/\text/\place in {
   ...
   11/-5/\parbox{1.7cm}{\textbf{Resource awareness}}/\placelast
  } {
...
\path (11, 2) node {
	\includegraphics[width=20pt, height=20pt]{library}
} (12.4,1.9) node {{\scriptsize Contributions}}
;
\draw[line width=0.1cm, draw=red!70] (10.7, 1.2)--(11.3,1.2) (12.4,1.2) node {{\scriptsize Thesis's way}}
;
