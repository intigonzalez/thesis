...
\addplot+[mark=*] coordinates
  ...
  \end{axis}
  \end{tikzpicture}
  \caption{Time to obtain the reply to\newline all requests.\label{fig:execution-time-web-app}}
  \end{minipage}
 \begin{minipage}[t]{0.45\linewidth}
 \begin{tikzpicture}
 \begin{axis}[
 ...
 \end{axis}
 \end{tikzpicture}
 \caption{Average delay time to detect\newline a faulty \textit{sosie}.\label{fig:delay-time-web-app}}
\end{minipage}
