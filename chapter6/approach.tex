...
Informally, the term \textit{memory profiling} refers to any kind of \textbf{\textit{process to collect}} some \textbf{\textit{data about memory usage}}.
...
The following examples show what kind of operations must be executed during the exploration of the graph.
...
\item Identifying structures in the heap by using a parameter. For instance, in this example we know that there are two structures because there are two instance of class \textit{SimplyLinkedList}.
\end{itemize}
