...
%\begin{enumerate}
%\item Reduce the amount\selectlanguage{english} of CPU and memory used to determine the resources consumed by different parts of an application built to execute on top of managed runtime environments.\\
